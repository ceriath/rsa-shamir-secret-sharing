...
// and generator a.  The Reed-Solomon encoding in QR codes uses
...
func NewField(poly, a int) *Field {
	...
	for i := 0; i < 255; i++ {
		if x == 1 && i != 0 {
			panic("gf256: invalid generator " + strconv.Itoa(a) +
...
// nbit returns the degree of polynomial p.
...
// Exp returns the base-a exponential of e in the field.
...
// Log returns the base-a logarithm of x in the field.
